...
// Fetch articles for a specific month (Hilal Her only)
const fetchMonthArticlesHer = async (monthYear) => {
    try {
        ...
        params.append('publication', 'Hilal Her');
...
const MonthArticlesHer = () => {
    ...
    const { data: articles = [], isLoading, error } = useQuery({
        queryKey: ["monthArticlesHer", monthYear],
        queryFn: () => fetchMonthArticlesHer(monthYear),
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-4 mb-4">
                                <Link to="/hilal-her" className="text-gray-500 hover:text-gray-700">
                                    <ChevronLeft className="w-5 h-5" />
                                </Link>
                                <h1 className="text-3xl font-bold text-gray-800">
                                    HILAL HER {displayDate}
                                </h1>
                            </div>
                            <p className="text-gray-600 mb-4">
                                Content focused on women's issues, empowerment, and perspectives from {displayDate}.
                            </p>
                                ...
                                <div key={article.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden">
                                    ...
                                    <div className="p-4">
                                        <Link 
                                            ...
                                            className="text-lg font-semibold text-gray-800 hover:text-pink-600 transition-colors line-clamp-2 mb-2 block"
                                        >
                                        ...
                                        <Link 
                                            to={`/article/${article.id}`}
                                            className="text-pink-600 hover:text-pink-700 font-medium text-sm transition-colors float-right"
                                        >
                                            Read More →
                                        </Link>
...
export default MonthArticlesHer;
